...
I am a Junior Python Backend Developer with a strong interest in building practical systems and continuously improving my backend skills using Django.

At the beginning of my Python learning journey, I built a complete desktop POS (Cashier) system using Tkinter. This project helped me understand core programming concepts such as application flow, data handling, user interaction, and working with databases in a real-world scenario.
